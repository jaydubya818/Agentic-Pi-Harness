...
const mk = (id: string, result: "approve" | "deny" | "ask", ruleId: string | null): PolicyDecision => ({
  schemaVersion: 1, toolCallId: id, result, provenanceMode: "full",
  matchedRuleIds: ruleId ? [ruleId] : [], winningRuleId: ruleId,
  evaluationOrder: ["r1", "r2"], modeInfluence: "assist",
  manifestInfluence: null, hookInfluence: null, at: "2026-04-08T00:00:00Z",
});
